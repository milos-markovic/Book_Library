...
<div class="container">
    ...
    <div class="row py-4">
        ...
        <div class="col-md-8 mx-auto mb-5">
            ...
            <form action="" method="POST" enctype="multipart/form-data" id="createNews" >
                <div class="form-group">
                    <label for="title">Title: </label>
                    <input type="text" name="naslov" id="title" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="news">News: </label>
                    <textarea name="vest" id="" cols="30" rows="8" class="form-control" required ></textarea>
                </div>
                <div class="form-group">
                    <label for="autor">Autor: </label>
                    <input type="autor" name="autor" id="autor" class="form-control" required >
                </div>
                <div class="form-group">
                    <label for="datum">Date: </label>
                    <input type="text" name="datum" id="datum" class="form-control" required >
                </div>
                <div class="form-group">
