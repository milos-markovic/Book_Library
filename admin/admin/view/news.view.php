...
<div class="container py-5">
    ...
    <?php if( count($getNews) > 0 ): ?>
        <div class="card my-4">
            <table class="table table-hover table-borderles m-0" id="newsTable">
                <thead>
                    <tr>
                        <th>Image</th>
                        <th>Title</th>
                ...
                <tbody>
                    <?php foreach($getNews as $news): ?>
                        <tr>
                            <td class="p-0"><img src="../../asets/news_img/<?php echo $news->img; ?>" alt="news image" class="img-fluid news_img" style=" width: 100px;"></td>
