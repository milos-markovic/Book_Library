        ...
        <div class="col-8">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="naslov" id="naslov" class="form-control" value="<?php echo $getNews->title; ?>">
                </div>
                <div class="form-group">
                    <label for="News">News:</label>
                    <textarea name="vest" id="vest" cols="30" rows="10" class="form-control" ><?php echo $getNews->news; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="autor">Autor:</label>
                    <input type="text" name="autor" id="autor" class="form-control" value="<?php echo $getNews->autor; ?>">
                </div>     
                <div class="form-group">
